            ...
            <div class="row">
                <div class="col-md-12 col-lg-5">
                    <div class="banner banner-large banner-overlay banner-overlay-light">
                        <a href="{{url('shop?filter=customize')}}">
                        ...
                        <div class="banner-content banner-content-top">
                            ...
                            <a href="{{url('shop?filter=customize')}}" class="btn btn-outline-white banner-link">Shop Now<i
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="banner banner-overlay">
                        <a href="{{url('category/tshirts')}}">
                            <img src="{{asset('frontend/assets/images/demos/demo-2/banners/banner-2.jpg')}}"
                                alt="Banner">
                        </a>
                        ...
                        <div class="banner-content banner-content-bottom">
                            ...
                            <a href="{{url('category/tshirts')}}" class="btn btn-outline-white banner-link">Discover Now<i
                                    class="icon-long-arrow-right"></i></a>
                        </div><!-- End .banner-content -->
                    </div><!-- End .banner -->
                </div><!-- End .col-lg-3 -->
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="banner banner-overlay">
                        <a href="{{url('category/key-chains')}}">
                            <img src="{{asset('frontend/assets/images/demos/demo-2/banners/banner-3.jpg')}}"
                                alt="Banner">
                        </a>
                        ...
                        <div class="banner-content banner-content-top">
                            ...
                            <!-- End .banner-title -->
                            <a href="{{url('category/key-chains')}}" class="btn btn-outline-white banner-link">Discover Now<i
                                    class="icon-long-arrow-right"></i></a>
                        </div><!-- End .banner-content -->
                    </div><!-- End .banner -->

                    <div class="banner banner-overlay banner-overlay-light">
                        <a href="{{url('category/led-lamps')}}">
                            <img src="{{asset('frontend/assets/images/demos/demo-2/banners/banner-4.jpg')}}"
                                alt="Banner">
                        </a>
                        ...
                        <div class="banner-content banner-content-top">
                            ...
                            <a href="{{url('category/led-lamps')}}" class="btn btn-outline-white banner-link text-white">Shop Now<i
                                    class="icon-long-arrow-right"></i></a>
                        </div><!-- End .banner-content -->
                    </div><!-- End .banner -->
                </div><!-- End .col-lg-4 -->
